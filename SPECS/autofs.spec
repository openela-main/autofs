...
Patch0: autofs-5.1.9-update-configure.patch
Patch1: autofs-5.1.9-fix-ldap_parse_page_control-check.patch
Patch2: autofs-5.1.9-fix-crash-in-make_options_string.patch
Patch3: autofs-5.1.9-Fix-incompatible-function-pointer-types-in-cyrus-sasl-module.patch
Patch4: autofs-5.1.9-fix-always-recreate-credential-cache.patch
Patch5: autofs-5.1.9-fix-get-parent-multi-mount-check-in-try_remount.patch
Patch6: autofs-5.1.9-fix-deadlock-in-remount.patch
Patch7: autofs-5.1.9-fix-amd-external-mount-error-handling.patch
Patch8: autofs-5.1.9-fix-amd-external-mount-mount-handling.patch
Patch9: autofs-5.1.9-dont-free-ext-mount-if-mounted.patch
Patch10: autofs-5.1.9-refactor-amd-function-do_program_mount.patch
Patch11: autofs-5.1.9-refactor-amd-function-umount_amd_ext_mount.patch
Patch12: autofs-5.1.9-add-flags-argument-to-amd-do_program_mount.patch
Patch13: autofs-5.1.9-fix-amd-cache-options-not-copied.patch
Patch14: autofs-5.1.9-seperate-amd-mount-and-entry-flags.patch
